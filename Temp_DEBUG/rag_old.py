...
def direct_answer():
    ...
    Respond clearly and concisely based on the user's input."""
...
def user_query(question):
    ...
    # async for output in graph.astream({"messages": [HumanMessage(content=question)]}):
    #         pprint.pprint(output.items(), indent=2, width=80, depth=None)
    # return None
